...
$(document).ready(function () {
  ...
  $('#add-contact-item').on('click', function (e) {
    ...
    userDataTable.row.add([
      ...
      '<input required  type="checkbox" class="custom-control-input" id="checkboxsmallall1234">' +
  ...
  $('#edit-contact-item').on('click', function (e) {
    ...
    userDataTable.row(currentRow).data([
      '<div class="custom-control custom-checkbox">' +
      '<input required  type="checkbox" class="custom-control-input" id="checkboxsmallall123">' +
