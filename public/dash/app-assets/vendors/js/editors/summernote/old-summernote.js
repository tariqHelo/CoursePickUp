...
var checkbox = renderer.create('<div class="checkbox"></div>', function ($node, options) {
    $node.html([
        ...
        ' <input required  role="checkbox" type="checkbox"' + (options.id ? ' id="' + options.id + '"' : ''),
...
var LinkDialog = /** @class */ (function () {
    ...
    LinkDialog.prototype.initialize = function () {
        ...
        var body = [
            ...
            '<input required  class="note-link-text form-control note-form-control  note-input" type="text" />',
            '</div>',
            '<div class="form-group note-form-group">',
            "<label class=\"note-form-label\">" + this.lang.link.url + "</label>",
            '<input required  class="note-link-url form-control note-form-control note-input" type="text" value="http://" />',
            '</div>',
...
var ImageDialog = /** @class */ (function () {
    ...
    ImageDialog.prototype.initialize = function () {
        ...
        var body = [
            ...
            '<input required  class="note-image-input note-form-control note-input" ',
            ' type="file" name="files" accept="image/*" multiple="multiple" />',
            imageLimitation,
            '</div>',
            '<div class="form-group note-group-image-url" style="overflow:auto;">',
            '<label class="note-form-label">' + this.lang.image.url + '</label>',
            '<input required  class="note-image-url form-control note-form-control note-input ',
            ' col-md-12" type="text" />',
            '</div>'
        ].join('');
...
var VideoDialog = /** @class */ (function () {
    ...
    VideoDialog.prototype.initialize = function () {
        ...
        var body = [
            ...
            '<input required  class="note-video-url form-control note-form-control note-input" type="text" />',
            '</div>'
        ].join('');
