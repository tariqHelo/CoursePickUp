...
@section('title')
<title>Articles Form List</title>
@endsection
@section('content')
<div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">Articles Form List</h3>
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Articles Form</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="content-header-right col-md-6 col-12">
            <div class="media width-250 float-right">
                ...
                <div class="media-body media-right text-right">
                    ...
                    <span class="text-muted">Total Article Leads</span>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Article Leads</h4>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a class="phone"
                                                                href="{{route('leadsShow',[$id,$row->id])}}">{{$row->phone}}
                                                            </a>
                                                        </td>
                                                        <td>
