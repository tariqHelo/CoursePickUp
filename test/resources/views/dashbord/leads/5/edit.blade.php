...
@section('title')
<title> Work With Edit</title>
@endsection
@section('content')


<div class="content-wrapper">
    <h2 class="pb-2">Edit Work With Us Leads :</h2>
    <div class="card ">
        ...
        <form method="POST" action="{{route('leadsUpdate',[$id,$data->id])}}" class="ml-1 mt-1 mr-1">
            ...
            <fieldset class="form-group form-group-style ">
               ...
               <input required  type="text" name="institution" class="form-control" id="textbox2"
                    value="{{$data->institution}}" placeholder="Institution ....">
            </fieldset>
