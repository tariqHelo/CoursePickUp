...
<div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">Booking Form List</h3>
        ...
        <div class="content-header-right col-md-6 col-12">
            <div class="media width-250 float-right">
                ...
                <div class="media-body media-right text-right">
                    ...
                    <span class="text-muted">Total Booking Leads</span>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Booking Leads</h4>
                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="users-contacts"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a class="media-heading name">{{$row->fName}} {{$row->lName}}</a>
                                                        </td>
                                                        ...
                                                        <td class="phone">
                                                            @foreach (App\nationalities::all() as $item)
                                                                @if($item->id == $row->nationality)
                                                                        {{$item->titleEn}}
                                                                @endif
                                                            @endforeach
                                                        </td>
