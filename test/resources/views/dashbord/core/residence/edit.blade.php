...
@section('title')
<title>Edit Places of Residence </title>
@endsection
@section('content')

<div class="content-wrapper">
    <h2 class="pb-2">Edit Places of Residence :</h2>
    <div class="card ">

        <form method="POST" action="{{route('residence.update',$data->id)}}" class="ml-1 mt-1 mr-1">
            @method('PUT')
            @csrf
