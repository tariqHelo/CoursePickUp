                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="heading-elements">
                                ...
                                <a href="{{route('nationality.create')}}">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{route('nationality.edit',$row->id)}}">
                                                            ...
                                                            <button type="button"
                                                                onclick="document.getElementById('deleteNationality_{{$row->id}}').submit()"
                                                                class="btn btn-sm round btn-outline-danger">Delete</button>
                                                            <form hidden id="deleteNationality_{{$row->id}}"
                                                                action="{{route('nationality.destroy',$row->id)}}"
                                                                method="POST">
                                                                @method('Delete')
                                                                @csrf
                                                            </form>
