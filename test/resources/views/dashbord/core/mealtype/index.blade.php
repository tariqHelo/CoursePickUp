                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{route('mealtype.edit',$row->id)}}">
                                                            ...
                                                            <button type="button"
                                                                onclick="document.getElementById('deleteMealType_{{$row->id}}').submit()"
                                                                class="btn btn-sm round btn-outline-danger">Delete</button>
                                                            <form hidden id="deleteMealType_{{$row->id}}"
                                                                action="{{route('mealtype.destroy',$row->id)}}"
                                                                method="POST">
                                                                @method('Delete')
                                                                @csrf
                                                            </form>
