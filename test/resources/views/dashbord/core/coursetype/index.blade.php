                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{route('coursetype.edit',$row->id)}}">
                                                            ...
                                                            <button type="button"
                                                                onclick="document.getElementById('deleteCourseType_{{$row->id}}').submit()"
                                                                class="btn btn-sm round btn-outline-danger">Delete</button>
                                                            <form hidden id="deleteCourseType_{{$row->id}}"
                                                                action="{{route('coursetype.destroy',$row->id)}}"
                                                                method="POST">
                                                                @method('Delete')
                                                                @csrf
                                                            </form>
