                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="heading-elements">
                                ...
                                <a href="{{route('accommodationstype.create')}}">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{route('accommodationstype.edit',$row->id)}}">
                                                            ...
                                                            <button type="button"
                                                                onclick="document.getElementById('deleteAccommodationstype_{{$row->id}}').submit()"
                                                                class="btn btn-sm round btn-outline-danger">Delete</button>
                                                            <form hidden id="deleteAccommodationstype_{{$row->id}}"
                                                                action="{{route('accommodationstype.destroy',$row->id)}}"
                                                                method="POST">
                                                                @method('Delete')
                                                                @csrf
                                                            </form>
