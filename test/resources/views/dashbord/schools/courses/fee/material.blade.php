                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h2>Materialt Fee ({{$course->titleEn}})</h2>
                        ...
                        <section class="row all-contacts">
                            <div class="col-12">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <!-- Task List table -->
                                        <form method="POST" action="{{route('storeCoursesMaterialFee',$course->id)}}"
                                            id="storeCoursesMaterialFee" class="ml-1 mt-1 mr-1">
                                            @csrf
                                            <div class="form-group form-group-style mb-2 ml-1 mr-1 contact-repeater">

                                                <div class="form-group form-group-style mb-2 mt-1 "
                                                    ...
                                                    <div class="input-group mb-1 row ThisRow" data-repeater-item>
                                                        ...
                                                        <fieldset class="form-group col-6">
                                                            <label class="mb-1" for="fromWeek">From number of weeks
                                                                :</label>
                                                            <select required class="custom-select fromWeek"
                                                                id="fromWeek" name="fromWeek">
                                                        ...
                                                        <fieldset class="form-group col-12" hidden>
                                                            ...
                                                            <input  type="text" class="form-control"
                                                                id="this_id" name="this_id" placeholder="Title Ar ....">
                                                        </fieldset>

                                                        <fieldset class="form-group col-6">
                                                            <label class="mb-1" for="toWeek">To number of weeks:</label>
                                                            <select required class="custom-select toWeek" id="toWeek"
                                                                name="toWeek">
                                                        ...
                                                        <fieldset class="form-group col-6">
                                                            ...
                                                            <input required type="text" class="form-control" id="fee"
                                                                name="fee" placeholder="Amount">
                                                        </fieldset>

                                                        <span class="input-group-append col-12" id="button-addon2">
                                                            <button class="btn btn-danger" type="button"
                                                                data-repeater-delete><i class="ft-x"></i></button>
                                                        </span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-actions text-center mb-2 ml-1 mr-1">
                                                ...
                                                <button type="submit" onclick="document.getElementById('').submit();"
	...
	$('.file-repeater, .contact-repeater').repeater({
		...
		hide: function(remove) {
			...
			if (confirm('Are you sure you want to remove this item?')) {
				$.ajax({
                    url : '{{route('deleteCoursesMaterialFee')}}'+'/'+ thisId,
                    type:'DELETE',
...
@if($course->weeksrangematerial_fees->count() !== 0)
...
$repeater.setList([
    @foreach($course->weeksrangematerial_fees as $multi)
    {
        'this_id' : '{{$multi->id}}',
        'fromWeek': '{{$multi->fromWeek}}',
        'toWeek': '{{$multi->toWeek}}',
        'materialTypeId': '{{$multi->id}}',
        'fee': '{{$multi->fee}}',
    },
    @endforeach
