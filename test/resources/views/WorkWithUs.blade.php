                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{__("messages.من نحن")}}</li>
                                </ol>
                            </nav>
                                    ...
                                    <div class="col-12 col-lg-10 col-xl-9">
                                        ...
                                        <div class="border-top pv-60">
                                            ...
                                            <div class="container">
                                                ...
                                                <form action="{{route('sendLeadsPageWorkWithUs')}}"
                                                      method="POST"
                                                    ...
                                                    <div class="row gap-20 align-items-center mb-0 mt-30">
                                                        ...
                                                        <div class="col-12 col-md-2">
                                                            <div class="col-inner">
                                                                ...
                                                                <input type="submit" class="btn px-0 btn-primary btn-block"
                                                                       value='{{__("messages.إرسال الإستشارة")}}'>
