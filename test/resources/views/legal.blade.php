                        ...
                        <div class="col-12 col-md-7">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">{{__("messages.قوانين")}}</li>
                                </ol>
                            </nav>
                            <h4 class="mt-0 line-125">{{__("messages.قوانين")}}</h4>
                    ...
                    <div class="col-12 col-lg-12">
                        ...
                        <div class="content-wrapper">
                            ...
                            <article class="blog-single-wrapper full-width">
                                ...
                                <h3 class="heading-title"><span>{{__("messages.قوانين متعلقة ببيك أب كورس")}}</span>
                                </h3>
