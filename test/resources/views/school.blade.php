...
<div class="loader-acc">

@for($i=16; $i<20; $i++)
<div class="accommodation-modal ajax-load pt-30" id="accommodation-{{$i}}-modal-div">
    <div class="container contai-padd">
    ...
    <script type="text/javascript">
        ...
        $('#weeks').change(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    $(".loader").load(location.href + " .courseSectionContainer")
                    $(".loader-acc").load(location.href + " .accommodation-modal.ajax-load")
