                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{__("messages.إفادة")}}</li>
                                </ol>
                            </nav>
                            <h4 class="mt-0 line-125">{{__("messages.إفادة")}}</h4>
                                ...
                                <div class="row justify-content-center ">
                                    ...
                                    <div class="col-12 col-lg-10 col-xl-9">
                                        ...
                                        <div class="border-top pv-60">
                                            ...
                                            <div class="container">
                                                @if(app()->getLocale() == 'ar')
                                                <h4 class="heading-title"><span>أرسل <span class="font200">لنا ملاحظاتك</span></span></h4>
                                                @else
                                                <h4 class="heading-title"><span>Leave us <span class="font200">a Feedback</span></span></h4>
                                                @endif

                                                <form action="{{route('formSendFeedBacks')}}"
                                                      method="POST"
