...
var modern = (function () {
    ...
    var ComboBox = Widget.extend({
      ...
      renderHtml: function () {
        ...
        return '<div id="' + id + '" class="' + self$$1.classes + '">' + '<input required  id="' + id + '-inp" class="' + prefix + 'textbox" value="' + self$$1.encode(value, false) + '" hidefocus="1"' + extraAttrs + ' placeholder="' + self$$1.encode(settings.placeholder) + '" />' + statusHtml + openBtnHtml + '</div>';
      },
    ...
    var SelectBox = Widget.extend({
      ...
      renderHtml: function () {
        ...
        return '<select required id="' + self._id + '" class="' + self.classes + '"' + size + '>' + options + '</select>';
      },
      bindStates: function () {
        var self = this;
