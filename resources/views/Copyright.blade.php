                        ...
                        <div class="col-12 col-md-7">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">{{__("messages.حقوق النشر")}}</li>
                                </ol>
                            </nav>
                            <h4 class="mt-0 line-125">{{__("messages.حقوق النشر")}}</h4>
                    ...
                    <div class="col-12 col-lg-12">
                        ...
                        <div class="content-wrapper">
                            ...
                            <article class="blog-single-wrapper full-width">
                                ...
                                <h3 class="heading-title"><span>{{__("messages.قوانين حقوق النشر الخاصة بنا")}}</span>
                                </h3>
