                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{route('roomtype.edit',$row->id)}}">
                                                            ...
                                                            <button type="button"
                                                                onclick="document.getElementById('deleteRoomType_{{$row->id}}').submit()"
                                                                class="btn btn-sm round btn-outline-danger">Delete</button>
                                                            <form hidden id="deleteRoomType_{{$row->id}}"
                                                                action="{{route('roomtype.destroy',$row->id)}}"
                                                                method="POST">
                                                                @method('Delete')
                                                                @csrf
                                                            </form>
