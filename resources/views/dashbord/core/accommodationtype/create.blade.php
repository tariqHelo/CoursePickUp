...
@section('title')
<title>Add Accommodation Type </title>
@endsection
@section('content')

<div class="content-wrapper">
    <h2 class="pb-2">Add Accommodation Type :</h2>
    <div class="card ">

        <form method="POST" action="{{route('accommodationstype.store')}}" class="ml-1 mt-1 mr-1" >
            @csrf
            ...
            <fieldset class="form-group form-group-style">
                ...
                <input required  type="text" name="slugEn" class="form-control" id="textbox3"
                    placeholder="Slug En ...." />
            </fieldset>
            <fieldset class="form-group form-group-style">
                <label for="textbox2">Slug Ar</label>
                <input required  type="text" name="slugAr" class="form-control" id="textbox4"
                    placeholder="Slug Ar ...." />
            </fieldset>
