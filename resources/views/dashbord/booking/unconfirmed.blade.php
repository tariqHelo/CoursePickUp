...
@section('title')
<title>Booking Requests (Unconfirmed)</title>
@endsection
@section('content')
...
<div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">Booking Requests List (Unconfirmed)</h3>
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Booking Requests (Unconfirmed)</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Booking Requests (Unconfirmed) </h4>
                        </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="pr-0">
                                                            ...
                                                            <a href="{{ route('booking.requests.edit', [$request->id, 'unconfirmed']) }}" class="primary mr-1">
